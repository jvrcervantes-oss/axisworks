...
$T = [
  'en' => [
    ...
    'hj_s'=>['What it is','Seen working','How it flows','What&rsquo;s included','Questions'],'hj_more'=>'More detail',
  ...
  'es' => [
    ...
    'hj_s'=>['Qué es','Funcionando','Cómo fluye','Qué incluye','Preguntas'],'hj_more'=>'Más detalle',
