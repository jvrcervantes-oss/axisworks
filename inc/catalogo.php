...
$T = [
  'en' => [
    ...
    'fc_name'=>'Your name','fc_email'=>'Work email','fc_company'=>'Company','fc_msg'=>'What do you need?',
    'fc_msg_ph'=>'What you run on today and what hurts: spreadsheets, WhatsApp, five tools that do not talk to each other…',
    'fc_req'=>'REQUIRED','fc_opt'=>'OPTIONAL','fc_send'=>'Send','fc_sending'=>'Sending…',
    'fc_ok'=>'Received. We reply within one working day, in English or Spanish.',
    'fc_val'=>'Check the fields: name, a valid email and a message of at least 10 characters.',
    'fc_err'=>'It did not go through. Write to us directly at','fc_lim'=>'Too many messages from this connection. Write to us directly at',
    'lg_legal'=>'Legal notice','lg_privacy'=>'Privacy','lg_cookies'=>'Cookies','lg_updated'=>'Last updated',
  ...
  'es' => [
    ...
    'fc_name'=>'Tu nombre','fc_email'=>'Email de trabajo','fc_company'=>'Empresa','fc_msg'=>'¿Qué necesitas?',
    'fc_msg_ph'=>'Con qué funcionáis hoy y qué os duele: hojas de cálculo, WhatsApp, cinco herramientas que no se hablan…',
    'fc_req'=>'OBLIGATORIO','fc_opt'=>'OPCIONAL','fc_send'=>'Enviar','fc_sending'=>'Enviando…',
    'fc_ok'=>'Recibido. Contestamos en un día laborable, en español o inglés.',
    'fc_val'=>'Revisa los campos: nombre, un email válido y un mensaje de al menos 10 caracteres.',
    'fc_err'=>'No ha salido. Escríbenos directamente a','fc_lim'=>'Demasiados mensajes desde esta conexión. Escríbenos directamente a',
    'lg_legal'=>'Aviso legal','lg_privacy'=>'Privacidad','lg_cookies'=>'Cookies','lg_updated'=>'Última actualización',
