...
'software-de-gestion-a-medida' => [
  ...
  'panel'=>['tool'=>'SUITE LAWANG // HOY','th'=>['Ref','Asunto','Herramienta','Estado','Vence'],'rows'=>[
  ...
  'caso'=>[
    ...
    'cifras'=>[['32','herramientas bajo un menú'],['12','funciones de servidor'],['1','fuente por dato']],
  ],
],

'crm-a-medida' => [
  'regla'=>'Un CRM al que alguien tiene que copiar los leads es una hoja de cálculo con una interfaz más lenta.',
  'panel'=>['tool'=>'LEADS // EMBUDO','th'=>['Ref','Origen','Fase','Responsable','Siguiente paso'],'rows'=>[
  ...
  'caso'=>[
    ...
    'cifras'=>[['0','leads copiados a mano'],['4h','sincronización con Meta'],['1','ficha por comprador']],
  ],
],

'chatbot-whatsapp-ia' => [
  'regla'=>'Un bot que improvisa sobre dinero es un riesgo. Los nuestros pasan a una persona en cuanto el dinero no está claro.',
  'panel'=>['tool'=>'SETTER // CONVERSACIONES','th'=>['Ref','Idioma','Intención','Bot','Traspaso'],'rows'=>[
  ...
  'caso'=>[
    ...
    'cifras'=>[['2','bots: compradores y comerciales'],['1','lista de números antes de abrir'],['0','precios que pueda inventarse']],
  ],
],

'automatizacion-de-procesos' => [
  'regla'=>'Un vigilante puede pausar, parar y proteger por su cuenta. Nunca puede gastar, crear ni escribir a un cliente.',
  'panel'=>['tool'=>'VIGILANTES // ÚLTIMA PASADA','th'=>['Regla','Comprueba','Resultado','Acción','Próxima'],'rows'=>[
  ...
  'caso'=>[
    ...
    'cifras'=>[['13','reglas escritas'],['4h','intervalo de revisión'],['0','gasto fuera del tope']],
  ],
],

'portal-de-clientes' => [
  'regla'=>'El acceso es una regla, no un favor: ficha más contrato abre la puerta.',
  'panel'=>['tool'=>'PORTAL DEL COMPRADOR // MI EXPEDIENTE','th'=>['Doc','Tipo','Estado','Pago','Vence'],'rows'=>[
  ...
  'caso'=>[
    ...
    'cifras'=>[['1','base para oficina y compradores'],['0','invitaciones que mandar'],['1','expediente por comprador, solo el suyo']],
  ],
],

'integraciones-y-datos' => [
  'regla'=>'Cada dato tiene un dueño. Copiar en las dos direcciones es la forma de acabar con dos sistemas que no coinciden.',
  'panel'=>['tool'=>'INTEGRACIONES // EJECUCIONES','th'=>['Origen','Destino','Qué','Última','Estado'],'rows'=>[
  ...
  'caso'=>[
    ...
    'cifras'=>[['5','sistemas alimentando una base'],['0','movimientos importados dos veces'],['1','dueño por dato']],
  ],
],

'diseno-y-desarrollo-web' => [
  'regla'=>'La web y la intranet leen la misma base. Una cifra nunca vive en dos sitios.',
  'panel'=>['tool'=>'LAWANGPROPERTIES.COM // PÁGINAS','th'=>['Página','Qué hace','Lee de','Estado'],'rows'=>[
  ...
  'caso'=>[
    ...
    'cifras'=>[['3','idiomas de una sola fuente'],['1','base para web e intranet'],['0','plantillas']],
  ],
],
...
'meta-ads' => [
  ...
  'panel'=>['tool'=>'META ADS // CONJUNTOS, ÚLTIMOS 3 DÍAS','th'=>['Conjunto','Gasto','Leads','Regla','Acción'],'rows'=>[
  ...
  'caso'=>[
    ...
    'cifras'=>[['13','reglas del vigilante'],['4h','intervalo de revisión'],['0','presupuestos por encima del tope']],
  ],
],

'seo-y-sem' => [
  'regla'=>'Nadie puede prometer una posición. Lo que sí se puede prometer es que nada de tu propia web se lo impida.',
  'panel'=>['tool'=>'BÚSQUEDA // ESTRUCTURA','th'=>['Pieza','Dónde','Se genera de','Estado'],'rows'=>[
  ...
  'caso'=>[
    ...
    'cifras'=>[['3','idiomas emparejados en una web'],['2','webs sobre la misma base'],['0','posiciones prometidas']],
  ],
],

'redes-sociales-y-contenido' => [
  'regla'=>'Cada cuenta tiene un trabajo. Una pieza va a la cuenta cuyo trabajo hace.',
  'panel'=>['tool'=>'CREATIVIDADES // BIBLIOTECA','th'=>['Id','Formato','Cuenta','Estado','Legal'],'rows'=>[
  ...
  'caso'=>[
    ...
    'cifras'=>[['3','cuentas, tres trabajos'],['32','referencias del sector analizadas'],['1','lista de frases vetadas']],
  ],
],
...
'gestion-marca-y-rumbo' => [
  ...
  'panel'=>['tool'=>'DECISIONES // REGISTRO','th'=>['Fecha','Área','Decisión','Quién','Estado'],'rows'=>[
  ...
  'caso'=>[
    ...
    'cifras'=>[['1','sistema de marca: web, documentos, cuentas'],['32','herramientas ordenadas bajo un menú'],['1','registro de decisiones, fechado']],
  ],
],
